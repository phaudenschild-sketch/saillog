...
from masarasi import backup
from masarasi.storage import LogEntry, LogbookStore
...
class BackupTest(unittest.TestCase):
    ...
    def test_creates_zip_with_db_and_config(self):
        ...
        self.assertEqual(out.name, "masarasi-backup-20260710-120000.zip")
    ...
    def test_prune_keeps_newest(self):
        ...
        self.assertEqual(remaining, [
            "masarasi-backup-20260710-120000.zip",
            "masarasi-backup-20260710-130000.zip",
        ])
